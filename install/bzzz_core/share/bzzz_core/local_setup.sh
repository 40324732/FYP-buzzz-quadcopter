...
: ${AMENT_CURRENT_PREFIX:="/home/mbell/bzzz_ws/install/bzzz_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bzzz_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bzzz_core/environment/path.sh"
