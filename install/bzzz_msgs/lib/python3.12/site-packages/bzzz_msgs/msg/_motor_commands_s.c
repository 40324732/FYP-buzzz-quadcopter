...
bool bzzz_msgs__msg__motor_commands__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bzzz_msgs.msg._motor_commands.MotorCommands", full_classname_dest, 43) == 0);
  }
  bzzz_msgs__msg__MotorCommands * ros_message = _ros_message;
  {  // thrust
...
PyObject * bzzz_msgs__msg__motor_commands__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bzzz_msgs.msg._motor_commands");
