...
class Metaclass_SensorSuite(type):
    """Metaclass of message 'SensorSuite'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('bzzz_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'bzzz_msgs.msg.SensorSuite')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sensor_suite
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sensor_suite
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sensor_suite
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sensor_suite
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sensor_suite
...
class SensorSuite(metaclass=Metaclass_SensorSuite):
    """Message class 'SensorSuite'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.tof_distance = kwargs.get('tof_distance', float())
        self.baro_pressure = kwargs.get('baro_pressure', float())
    ...
    def __eq__(self, other):
        ...
        if self.gyro_z != other.gyro_z:
            return False
        if self.tof_distance != other.tof_distance:
            return False
        if self.baro_pressure != other.baro_pressure:
            return False
        return True
    ...
    def tof_distance(self):
        """Message field 'tof_distance'."""
        return self._tof_distance

    @tof_distance.setter
    def tof_distance(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'tof_distance' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'tof_distance' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._tof_distance = value

    @builtins.property
    def baro_pressure(self):
        """Message field 'baro_pressure'."""
        return self._baro_pressure

    @baro_pressure.setter
    def baro_pressure(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'baro_pressure' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'baro_pressure' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._baro_pressure = value
