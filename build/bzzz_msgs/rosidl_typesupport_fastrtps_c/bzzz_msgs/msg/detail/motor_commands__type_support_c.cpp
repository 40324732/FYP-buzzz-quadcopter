...
#include "bzzz_msgs/msg/detail/motor_commands__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCommands__ros_msg_type = bzzz_msgs__msg__MotorCommands;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bzzz_msgs__msg__MotorCommands;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const bzzz_msgs__msg__MotorCommands * ros_message = static_cast<const bzzz_msgs__msg__MotorCommands *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_bzzz_msgs__msg__MotorCommands(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  bzzz_msgs__msg__MotorCommands * ros_message = static_cast<bzzz_msgs__msg__MotorCommands *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_bzzz_msgs__msg__MotorCommands(cdr, ros_message);
}

static uint32_t _MotorCommands__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bzzz_msgs__msg__MotorCommands(
...
static size_t _MotorCommands__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_bzzz_msgs__msg__MotorCommands(
