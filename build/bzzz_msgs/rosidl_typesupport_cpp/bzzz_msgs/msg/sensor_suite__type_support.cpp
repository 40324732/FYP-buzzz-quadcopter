...
static const _SensorSuite_type_support_symbol_names_t _SensorSuite_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bzzz_msgs, msg, SensorSuite)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bzzz_msgs, msg, SensorSuite)),
  }
};
...
{
  return &::bzzz_msgs::msg::rosidl_typesupport_cpp::SensorSuite_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bzzz_msgs, msg, SensorSuite)() {
  return get_message_type_support_handle<bzzz_msgs::msg::SensorSuite>();
}
