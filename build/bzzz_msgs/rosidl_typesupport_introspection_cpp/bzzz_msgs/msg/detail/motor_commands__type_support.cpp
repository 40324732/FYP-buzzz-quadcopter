...
{
  new (message_memory) bzzz_msgs::msg::MotorCommands(_init);
}

void MotorCommands_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bzzz_msgs::msg::MotorCommands *>(message_memory);
  typed_message->~MotorCommands();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCommands_message_member_array[4] = {
  {
    "thrust",  // name
    ...
    offsetof(bzzz_msgs::msg::MotorCommands, thrust),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bzzz_msgs::msg::MotorCommands, roll),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bzzz_msgs::msg::MotorCommands, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bzzz_msgs::msg::MotorCommands, yaw_rate),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorCommands_message_members = {
  "bzzz_msgs::msg",  // message namespace
  "MotorCommands",  // message name
  4,  // number of fields
  sizeof(bzzz_msgs::msg::MotorCommands),
...
{
  return &::bzzz_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCommands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bzzz_msgs, msg, MotorCommands)() {
  return &::bzzz_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCommands_message_type_support_handle;
}
